---
title: "Coronavirus em Portugal"
layout: page
subheadline:  "Modelo SIR Coronavirus"
...
description: "Usar o softare R para construir o modelo SIR no caso de Portugal"
...
Para modelar a dinâmica do surto, precisamos de três equações diferenciais, uma para a mudança em cada grupo, onde é o parâmetro que controla a transição entre S e I e que controla a transição entre I e R:
...
Resolvendo, obtêm-se convergência e os seguintes parâmetros beta e gama. Podemos então fazer a representação gráfica:
...
Assim, R0 é estimado em 1,9, o que é consistente com o número que muitos pesquisadores e a OMS estimaram sendo aproximado do valor do SARS, Influenza ou Ébola. Existem diversos valores estimados que vão desde 1,4 até 3,5 para este parâmetro (https://www.worldometers.info/coronavirus/#repro).
